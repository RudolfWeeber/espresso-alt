...
to create a virtual particle which will be related to corresponding 
\"real\" one and will be situated at the same position. 

\minisec{Example}
The first (real) particle possess anisotropy energy and axis parallel 
...
\begin{code}
  ...
  part 1 vs_related 0 0 dip 0 1 0
  part 1 dipm 2.0
\end{code}

Magnetic anisotropy affect the rotation of the particle by the addition 
torques due to interaction between dipole moment and anisotropy axis, 
